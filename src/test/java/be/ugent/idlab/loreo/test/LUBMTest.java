...
//						dataFactory.getOWLClass("http://knowman.idlab.ugent.be/example#BackSupport")));
	    ...
	    Set<OWLAxiom> events1 = generateStudentMultiple(10, 0, dataFactory);
	    Set<OWLAxiom> events2 = generateStudentMultiple(10, 2000, dataFactory);
	    Set<OWLClass> result = cache.check(events1);
	    System.out.println(result);
	    long time1 = System.currentTimeMillis();
	    for(int i = 0; i<1;i++){
	    System.out.println(cache.check(events2));
	    }
